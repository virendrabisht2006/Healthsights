...
export class MeasurecreatorComponent implements OnInit {
    ...
    dataSoucreTypes = [{label: "Admin", value: 1}, {label: "ECDS", value: 2}, {
        label: "Hybrid",
        value: 3
    ...
    get formConditionList() {
        return <FormArray>this.configForm.get('conditionList');
    }

    get formConditionListDE() {
        return <FormArray>this.denominatorExclusion.get('DEList');
    }

    get formConditionListN() {
        return <FormArray>this.numerator.get('NList');
    }

    get formConditionListNE() {
        return <FormArray>this.numeratorExclusion.get('NEList');
    }
