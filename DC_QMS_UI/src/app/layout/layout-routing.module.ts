...
const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'Member Care Gap Registry',
                component: MemberCareGapListComponent,
            ...
            {
                path: 'measurelibrary/:type/:value',
                component: MeasurelibraryComponent,
                canActivate: [RoleGuardService],
                data: {
                    expectedRole: '6'
                }
            ...
            {
                path: 'measurecreator/:measureId/:type',
                component: MeasurecreatorComponent,
                canActivate: [RoleGuardService],
                data: {
                    expectedRole: '4' || '5'
                }
            ...
            {
                path: 'Chart Abstraction Tool',
                component: ChartAbstractionToolComponent,
                canActivate: [RoleGuardService],
                data: {
                    expectedRole: '12'
                }
