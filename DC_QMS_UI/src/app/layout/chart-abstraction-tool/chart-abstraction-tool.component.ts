...
export class ChartAbstractionToolComponent implements OnInit {
    ...
    navigateRecord() {
        this.visitDetails =
            [{
                memberId: this.Patients.patientId,
                provider: this.visitPatients.provider,
                encounterStartDate: this.visitPatients.encounterStartDate,
                encounterEndDate: this.visitPatients.encounterEndDate
                ,
                encounterCode: this.Patients.encounterType.split(","),
                encounterValueset: this.Patients.encounterType.split(","),
                chartType: "VISIT"
            }]
        ;
