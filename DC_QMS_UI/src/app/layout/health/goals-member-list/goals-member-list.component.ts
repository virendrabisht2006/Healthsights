...
export class GoalsMemberListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.cols = [
            ...
            {field: '', header: 'Action'},
            {
                field: ['physicalActivityGoal1', 'physicalActivityFrequency1', 'physicalActivityDate1', 'calorieIntakeGoal1', 'calorieIntakeFrequency1', 'calorieIntakeDate1', 'careGap1', 'careGapDate1'],
                header: 'Reccomendations'
            },
            {
                field: ['physicalActivityGoal', 'physicalActivityFrequency', 'physicalActivityDate', 'calorieIntakeGoal', 'calorieIntakeFrequency', 'calorieIntakeDate', 'careGap', 'careGapDate'],
                header: 'Goals Set'
            }
        ];
        //  console.log()
