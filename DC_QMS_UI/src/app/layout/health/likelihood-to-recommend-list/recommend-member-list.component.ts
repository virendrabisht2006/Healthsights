...
export class RecommendMemberListComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.cols = [
            ...
            {
                field: ['physicalActivityGoal', 'physicalActivityFrequency', 'physicalActivityDuration', 'calorieIintakeGoal', 'calorieIntakeFrequency', 'calorieIntakeDuration', 'careGap', 'careGapDuration'],
                header: 'Goals'
            },
            {
                field: ['performancePhysicalActivity', 'performanceCalorieIntake', 'performanceCareGap'],
                header: 'Performance'
            },
