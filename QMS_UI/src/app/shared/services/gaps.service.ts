...
export class GapsService {
    ...
    updateCloseGaps(formModel, targetDate, closeGaps, gapId, headers) {
        return this.http.post(`http://healthinsight:8082/curis/closeGaps/${closeGaps.memberId}/${gapId}`, {
            'careGaps': [{
    ...
    UserMappingSubmit(userId, roleId, status) {
        return this.http.post(`http://healthinsight:8082/curis/user_role/add_user_role`, {
            "userId": userId,
            "roleId": roleId,
            "status": status
        });
    ...
    createPersona(model, clusterId) {
        return this.http.post(`http://healthinsight:8082/curis/member_engagement/update_persona`, {
            "clusterId": clusterId,
