    ...
    <div class="sub-header">
        <div style="">
            <p style="font-size: xx-large;float: left; margin-top: 5.5vh;color: white;margin-left: 3vw" id="heading"><b>Measure
                Library</b></p>
            <i class="material-icons" data-toggle="tooltip" data-placement="right" title="Measure Library info"
        ...
        <div class="button-div">
            ...
            <form class="search-form" class="form-inline" role="form" style="float:right">
                <div class="input-group">
                    <input type="text" class="form-control search-form" placeholder="Search Library"
                           ng-model="searchLibrary">
