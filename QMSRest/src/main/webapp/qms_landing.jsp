...
<div class="col-md-12 no-padding-margin main-content">
    <div class="col-md-12 sub-header">
        <p style="font-size: xx-large;float: left; margin-top: 5.5vh;color: white;margin-left: 3vw" id="heading"><b>QMS
            Home</b></p>
            ...
            <form class="search-form" class="form-inline" role="form">
                <div class="input-group">
                    ...
                    <span class="input-group-btn"><button type="submit" class="btn btn-primary search-btn"
                            ...
                            src="images/SearchIcon.png" height="33.5px">
                        </button></span>
                </div>
            </form>
        </div>
                ...
                <tr>
                        ...
                        <div class="col-md-3 div-content">
                            <div class="div-content-box">
                                <div class="div_sub-content">
                                    <img src="images/Reembursement.png" width="60px" height="60px"
                                ...
                                <div class="border-box">
                                    ...
                                    <div class="tags">
                                        ...
                                        <table class="inside-content" id="tablesearch">
                                            <tr ng-repeat="program in reimbursementPrograms | filter:searchQMS track by $index"
                                                ng-if="
                                      program == 'Merit-Based Incentive Payment System (MIPS) Program'">
                                                ...
                                                <td class="td-images">
                                                    ...
                                                    <a
                                                            ng-href="MIPS.html">
                                                        <img src="images/Dashboard_icon.png" class=" pull-right"
                    ...
                    <td>
                        <div class="col-md-3 div-content">
                            <div class="div-content-box">
                                <div class="div_sub-content">
                                    <img src="images/Clinical.png" width="60px" height="60px"
                                         style="float: left; margin-top: 5px;">
                    ...
                    <td>
                        <div class="col-md-3 div-content">
                            <div class="div-content-box">
                                <div class="div_sub-content">
                                    <img src="images/NQF.png" width="60px" height="60px"
                                         style="float: left; margin-top: 5px;">
...
<script>
    if (annyang) {
        ...
        var commands = {
            ...
            'Show Health Insights HomePage': function () {
                responsiveVoice.speak('Showing Health Insights HomePage', "UK English Female");
                selectCurisHome();
            },
            'Show QMS HomePage': function () {
                responsiveVoice.speak('Showing QMS HomePage', "UK English Female");
                selectQmsHome();
            },
            'Show Diabetes Eye Exam': function () {
                responsiveVoice.speak('Showing Diabetes Eye Exam', "UK English Female");
                selectDiabetesExam();
            },
