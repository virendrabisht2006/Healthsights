        ...
        <div class="sub-content" id="sub-content">
            ...
            <div class=" col-md-12 no-padding-margin" style="background-color: #fff;height: 60vh;">
                ...
                <div class="col-md-6" style="padding-top: 3vh;">
                    <center>
                        <form>
                            <input ng-model="measureForm.programName" ng-disabled="isDisabled" name="browser"
                            ...
                            <input ng-model="measureForm.targetAge" ng-disabled="isDisabled" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Target Age">

                            <input ng-model="measureForm.measureDomain" ng-disabled="isDisabled" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Measure Domian">

                            <input ng-model="measureForm.measureCategory" ng-disabled="isDisabled" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Measure Category">

                            <input ng-model="measureForm.type" ng-disabled="isDisabled" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Type">

                            <input ng-model="measureForm.clinocalCondition" ng-disabled="isDisabled" name="browser"
                                   class="form-group form-control drop-down drop-margin"
                                   placeholder="Clinical Condition">

                            <input ng-model="measureForm.target" ng-disabled="isDisabled" name="browser"
                ...
                <div class="col-md-6" style="padding-top:3vh">
                    <center>
                        <input ng-model="measureForm.name" ng-disabled="isDisabled"
                               name="browser" class="form-group form-control drop-down drop-margin"
