...
<div class="col-md-12 no-padding-margin main-content ng-scope">
    ...
    <div class="col-md-12 sub-header">
        ...
        -->
        <span style="font-size: xx-large;float: left; margin-top: 1.5vh;color: white;margin-left: 3vw;line-height: 1.0"
              id="heading"><b>Measure Configurator</b> -
    ...
    <div class="col-md-12 sub-content">
        ...
        <div class="col-md-12" style="background-color:lightyellow;height:400px;width: 100%;">
            ...
            <form class="Field_Selection_Form">
                ...
                <button class="btn btn-cls" ng-click="submit('submit')" style="background-color: #A0F3D3;">Submit
                </button>
    ...
    <script type="text/ng-template" id="/queryBuilderDirective.html">
        ...
        <div class="alert alert-warning alert-group"
             style="background-color:lightyellow;overflow-y: scroll;height:280px;width: 100%;">
            <!--
            <div class="form-inline">
                    ...
                    <div ng-switch="rule.hasOwnProperty('group')">
                        ...
                        <div ng-switch-default="ng-switch-default">
                            <div class="form-inline">
                                ...
                                <!-- table names -->
                                <select style="margin-left: 5px;width: 250px;"
                                        ng-options="c.name as c.name for c in tableData"
                                        ng-model="rule.tableName" ng-change="onChangeTableName(rule.tableName,$index)"
                                        class="form-control input-sm">
                                    <option value="">Please Select Table Name</option>
                                </select>
                                <!-- column names -->
                                <select style="margin-left: 5px;width: 250px;"
                                        ng-options="c.name as c.name for c in rule.columnData"
                                        ng-model="rule.columnName" class="form-control input-sm">
                                    <option value="">Please Select Column Name</option>
                                </select>

                                <input style="margin-left: 5px;width: 250px;" type="text"
                                       ng-model="rule.businessExpression"
                                       size=40 class="form-control input-sm"
                                       ng-focus="businessExpressionFocus($event)"/>
                                ...
                                -->
                                <button style="margin-left: 5px" ng-click="addCondition()"
