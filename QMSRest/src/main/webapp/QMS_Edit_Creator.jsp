...
<div class="col-md-12 no-padding-margin main-content">
    <div class="sub-header">
        <p style="font-size: xx-large;float: left; margin-top: 5.5vh;color: white;margin-left: 3vw" id="heading"><b>Measure
            Editor</b></p>
        <i class="material-icons" data-toggle="tooltip" data-placement="right" title="Measure Editor info"
           style="font-size: 25px;font-weight: 600;margin-top: 6vh;float: left;margin-left: 1vw;cursor: pointer;">info_outline</i>
        <div class="button-div">
            <div class="col-md-12 submit-cls">

                <button ng-click="editClick()" class="btn btn-cls" style="background-color: #EFEFEF">Edit</button>
                <button ng-click="submitEdit('save')" class="btn btn-cls" style="background-color: #EFEFEF">Save
                </button>
                <!-- 
        <input type="submit" class="btn btn-cls" style="background-color: #EFEFEF" value="Save" >
                -->
                <button ng-click="submitEdit('submit')" class="btn btn-cls" style="background-color: #EFEFEF">Submit
                </button>

                <button class="btn-cls btn" style="background-color: #EFEFEF;"><a href="javascript://Save as TXT"
                                                                                  id="submitLink"
                                                                                  style="color: black;background-color: #EFEFEF;">Download</a></p>
                </button>
    ...
    <div class="sub-content" id="sub-content">
        ...
        <div class=" col-md-12 no-padding-margin"
             style="background-color: #fff;height: inherit; overflow: auto;border-left:rgba(6, 6, 6, 0.12) 1px solid;">
            <form action="#" class="form-horizontal ws-validate" method="post" id="formToSave">
                <div class="col-md-6" style="padding-top: 3vh;padding-left: 85px;"><label for="Program_Name">Program
                    Name*</label>
                    <input ng-model="measureForm.programName" list="measureProgramName" ng-disabled="isDisabled"
                           class="form-group form-control drop-down drop-margin" id="Program_Name"
                           ng-change="onChangeProgramName()"
                           required>
                    <datalist id="measureProgramName" name="measureProgramName">
                        <option ng-repeat="measureProgramName in measureProgramNames track by $index"
                                value="{{measureProgramName.name}}">
                    </datalist>

                    <label for="Measure_Title">Measure Title*</label>
                    <input ng-model="measureForm.name" ng-disabled="isDisabled" name=""
                           class="form-group form-control drop-down drop-margin" id="Measure_Title" required>
                    <label for="Description">Description*</label>
                    <input ng-model="measureForm.description" ng-disabled="isDisabled" name=""
                           class="form-group form-control drop-down drop-margin" id="Description" required>
                    <label for="Target_Age">Target Age*</label>
                    <input ng-model="measureForm.targetAge" ng-disabled="isDisabled"
                           class="form-group form-control drop-down drop-margin" id="Target_Age" required>

                    <label for="Measure_Domain">Measure Domain</label>
                    <input ng-model="measureForm.measureDomain" ng-disabled="isDisabled"
                           class="form-group form-control drop-down drop-margin" id="Measure_Domain"
                           list="measureDomain">
                    <datalist id="measureDomain" name="measureDomain">
                        <option ng-repeat="measureDomain in measureDomains track by $index"
                                value="{{measureDomain.name}}">
                    </datalist>
                    ...
                    <datalist id="measureCategory" name="measureCategory">
                        <option ng-repeat="measureCategory in measureCategories track by $index"
                    ...
                    <label for="Type">Type</label>
                    <select class="form-group form-control drop-down drop-margin" ng-model="measureForm.type"
                            ng-disabled="isDisabled" id="measureType" name="measureType"
                            ng-options="m.name for m in measureTypes">
                    </select>

                    <label for="Clinical_Conditions">Clinical Conditions</label>
                    <input ng-model="measureForm.clinocalCondition" ng-disabled="isDisabled"
                           class="form-group form-control drop-down drop-margin" id="Clinical_Conditions">
                ...
                <div class="col-md-6" style="padding-top:3vh;padding-left: 85px">
                    ...
                    <textarea ng-model="measureForm.denominator" ng-disabled="isDisabled"
                              class="form-control input_control form-group " rows="3" id="Denominator" type="text"
                              required></textarea>
                    ...
                    <textarea ng-model="measureForm.denomExclusions" ng-disabled="isDisabled"
                              class="form-control input_control form-group " rows="3" id="Denominator_Exclusions"
                              type="text"></textarea>
                    <label for="Numerator">Numerator*</label>
                    <textarea ng-model="measureForm.numerator" ng-disabled="isDisabled"
                              class="form-control input_control form-group " rows="3" type="text" id="Numerator"
                              required></textarea>
                    ...
                    <textarea ng-model="measureForm.numeratorExclusions" ng-disabled="isDisabled"
                              class="form-control input_control form-group " rows="3" type="text"
                              id="Numerator_Exclusions"></textarea>
                    <label for="Target">Target</label>
                    <input ng-model="measureForm.target" ng-disabled="isDisabled" name=""
                           class="form-group form-control drop-down drop-margin" id="Target">
