...
<div class="col-md-12 no-padding-margin main-content">
    <div class="sub-header">
        <p style="font-size: xx-large;float: left; margin-top: 5.5vh;color: white;margin-left: 3vw" id="heading"><b>Measure
            Worklist</b></p>
        <i class="material-icons" data-toggle="tooltip" data-placement="right" title="Measure worklist info"
        ...
        <div class="button-div">
            <form class="search-form" class="form-inline" role="form" style="float:right">
                <div class="input-group">
                    <input type="text" class="form-control search-form" placeholder="Search Worklist"
                           ng-model="searchWork">
                    <span class="input-group-btn"><button type="submit" class="btn btn-primary search-btn"
                                                          data-target="#search-form" name="q"
                                                          style="margin-top: 5px;padding: 0px;"><img
        ...
        <table class="table library">
            ...
            <tr ng-repeat="work in workList | filter:searchWork " ng-dblclick="dblClickWorkList()"
                ...
                <span class="TableImgsWork" ng-if="work.status =='Approved'">
  							   <img src="images/ListView_icon.png" style="float:right;" class="material-icons"
                                    data-toggle="tooltip" data-placement="right" title="open in Configurator"
                                    ng-click="measureConfigImgClick(work.id, work.name,work.status)"
                                    onMouseOver="this.style.cursor='pointer'">

                   <img src="images/Tickmark_green.jpg" style="float:right; opacity: 0.4;cursor: default;" width="25"
                        height="25" class="material-icons" data-toggle="tooltip" data-placement="right" title="Approve">

                   <img src="images/Cross_Red.jpg" style="float:right; opacity: 0.4;cursor: default;" width="25"
                        height="25" class="material-icons" data-toggle="tooltip" data-placement="right" title="Reject">

                </span>
                    <span class="TableImgsWork" ng-if="work.status =='Review'">
                   <img src="images/ListView_icon.png" style="float:right; opacity: 0.4;cursor: default;"
                        class="material-icons" data-toggle="tooltip" data-placement="right"
                        title="open in Configurator">

                   <img src="images/Tickmark_green.jpg" style="float:right;" width="25" height="25"
                        class="material-icons" data-toggle="tooltip" data-placement="right" title="Approve"
                        ng-click="statusClickImg('Approved', work.id)" onMouseOver="this.style.cursor='pointer'">

                   <img src="images/Cross_Red.jpg" style="float:right;" width="25" height="25" class="material-icons"
                        data-toggle="tooltip" data-placement="right" title="Reject"
                        ng-click="statusClickImg('Re-work', work.id)" onMouseOver="this.style.cursor='pointer'">
                </span>
