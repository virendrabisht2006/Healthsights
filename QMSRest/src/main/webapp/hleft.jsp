...
<header class="header col-md-12">
    ...
    float: right;">
        ...
        <li style="margin-right: 25px;margin-top: 0.4vh;">
            <div>
                <img src="images/doc.png" style=" height: 4vh;width: auto;" class="dropdown-toggle"
...
<div class="col-md-12 no-padding-margin" id="main_field">
    <div class="col-md-2 no-padding-margin nav-border-box left-pane">
        ...
        <p ng-class="{active:activeTab == '#!Measure_Library'}" ng-click="isActive('#!Measure_Library')"><a
                href="#!Measure_Library">Measure Library</a></p>
        <p ng-class="{active:activeTab == '#!Final_Creator'}" ng-click="isActive('#!Final_Creator')"><a
                href="#!Final_Creator">Measure Creator</a></p>
        <!-- <p><a href="Measure_Editor.html">Measure Editor</a></p> -->
        <p ng-class="{active:activeTab == '#!Measure_Worklist'}" ng-click="isActive('#!Measure_Worklist')"><a
                href="#!Measure_Worklist">Measure Worklist</a></p>

        <!-- <p><a href="#">Measure Configurator</a></p> -->
        <p ng-class="{active:activeTab == '#!Program_Creator'}" ng-click="isActive('#!Program_Creator')"><a
                href="#!Program_Creator">Program Creator</a></p>
        <!--
