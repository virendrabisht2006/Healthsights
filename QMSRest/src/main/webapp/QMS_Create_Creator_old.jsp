    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><i class="material-icons" style="font-size:25px; font-weight: 600;margin-top: 3px;">info_outline</i>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="col-md-10 no-padding-margin main-content">
        <div class="sub-header">
            ...
            <div class="button-div">
                <form class="search-form" class="form-inline" role="form" method="post" action="//www.google.com/search"
                      target="_blank">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn"><button type="submit" class="btn btn-primary search-btn"
                                                              ...
                                                              style="margin-top: 9px;padding: 0px;"><img
                                src="SearchIcon.png" height="33.5px">
                        </button></span>
                    </div>
                </form>
            </div>
        ...
        <div class="sub-content" id="sub-content">
            ...
            <div class=" col-md-12 no-padding-margin" style="background-color: #fff;height: 60vh;overflow-y:scroll;">
                ...
                <div class="col-md-6" style="padding-top: 3vh;">
                    <center>
                        <form>
                            <input ng-model="measureForm.programName" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Program Name">
                            <!--
                            ...
                            <input ng-model="measureForm.targetAge" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Target Age">
                            <datalist id="browsers">
                                <option value="Internet Explorer">
                                <option value="Firefox">
                                <option value="Chrome">
                            ...
                            <input ng-model="measureForm.measureDomain" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Measure Domian">
                            <datalist id="browsers">
                                <option value="Internet Explorer">
                                <option value="Firefox">
                                <option value="Chrome">
                            ...
                            <input ng-model="measureForm.measureCategory" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Measure Category">
                            <datalist id="browsers">
                                <option value="Internet Explorer">
                                <option value="Firefox">
                                <option value="Chrome">
                            ...
                            <input ng-model="measureForm.type" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Type">
                            <datalist id="browsers">
                                <option value="Internet Explorer">
                                <option value="Firefox">
                                <option value="Chrome">
                            ...
                            <input ng-model="measureForm.clinocalCondition" name="browser"
                                   class="form-group form-control drop-down drop-margin"
                            ...
                            <input ng-model="measureForm.target" name="browser"
                                   class="form-group form-control drop-down drop-margin" placeholder="Target">
                    </center>
                </div>
                <div class="col-md-6" style="padding-top:3vh">
                    <center>
                        <input ng-model="measureForm.name" name="browser"
                               class="form-group form-control drop-down drop-margin" placeholder="Measure Title">
                        <input ng-model="measureForm.description" name="browser"
                               class="form-group form-control drop-down drop-margin" placeholder="Description">
                        <textarea ng-model="measureForm.denominator" class="form-control input_control form-group "
                                  rows="2" id="Denominator" type="text" placeholder="Denominator"></textarea>
                        <textarea ng-model="measureForm.denomExclusions" class="form-control input_control form-group "
                                  rows="2" id="Denominator" type="text" placeholder="Denominator Exclusions"></textarea>
                        <textarea ng-model="measureForm.numerator" class="form-control input_control form-group "
                                  rows="2" id="Denominator" type="text" placeholder="Numerator"></textarea>
                        <textarea ng-model="measureForm.numeratorExclusions"
