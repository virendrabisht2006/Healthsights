...
<header class="header col-md-12" style="width:100%">
    ...
    <ul class="nav navbar-nav navbar-right" style="padding-right: 14px;display: -webkit-box;float: right;">
        <li><img src="images/speech.png"
                 style="width: auto; height: 5vh;cursor: pointer;margin-top: 0.5vh;float: left;margin-right: 15px;"
                 class=" SpeechIcon"></li>
                            ...
                            <tr>
                                <td>
                                    <div class="div1 Comorbi">
                                        ...
                                        <span class="numberCircle"><span
                                                ng-bind="patientProfileForm.comorbiditiesCount"></span>
			</span>
                                        <p>
                                ...
                                <td>
                                    <div class="div1">
                                        ...
                                        <span class="numberCircle"><span
                                                ng-bind="patientProfileForm.careGapsCount"></span>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="div1 NextApp">
                                        ...
                                        <p>Next Appointment Date: 15-Aug-2018
                                            <!--<span ng-bind="patientProfileForm.nextAppointmentDate"></span>--><br>
                                            Physician Name: Test,Physician
                                            <!--<span ng-bind="patientProfileForm.physicianName"></span>--><br>
                                            Department: Test Department
                                            <!--<span ng-bind="patientProfileForm.department"></span></p>-->
                                ...
                                <td>
                                    <div class="div1 VisitCount">
                                        <table title="Visit Counts" class="VistTable">
                                            <tr>
                                                <th colspan="3" style="text-align: center;">Visit Counts</th>
                                            </tr>
                                            <tr>
                                                <th>IP Visits</th>
                                                <th>OP Visits</th>
                            ...
                            <tr style="border:none;">
                                <td>
                                    <div class="div1 Procedures">
                                        ...
                                        <p>
            <span ng-bind="patientProfileForm.procedureName1"> - <span
                    ng-bind="patientProfileForm.procedureDateTime1"></span><br>
            <span ng-bind="patientProfileForm.procedureName2"> - <span
                    ng-bind="patientProfileForm.procedureDateTime2"></span>
                                        </p>
                                    </div>
